...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChallengeRank', function() {
      beforeEach(function() {
        instance = PhigrosApi.ChallengeRank;
      });

      it('should create an instance of ChallengeRank', function() {
        // TODO: update the code to test ChallengeRank
