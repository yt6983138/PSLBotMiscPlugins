...
```typescript
import type { NoReadOfCompleteQRCodeData } from ''
...
const example = {
  ...
  "url": null,
  "interval": null,
} satisfies NoReadOfCompleteQRCodeData
...
const exampleParsed = JSON.parse(exampleJSON) as NoReadOfCompleteQRCodeData
